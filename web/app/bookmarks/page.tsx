            ...
            <section key={date}>
              ...
              <div className="space-y-4">
                {grouped[date].map((bookmark) => (
                  <article key={bookmark.url} className="border-l-2 border-gray-100 dark:border-gray-800 pl-4">
                    <div className="flex items-start justify-between gap-2">
                      ...
                      <button
                        ...
                        className="shrink-0 text-gray-300 hover:text-red-400 dark:text-gray-600 dark:hover:text-red-400 transition-colors p-0.5"
                      >
